...
Later we can import `lending` module things with one line:
...
- Setup a task runner. _Cargo make_ is recommended. Here’s an example: [https://github.com/kawa-protocol/rover/blob/master/Makefile.toml](https://github.com/kawa-protocol/rover/blob/master/Makefile.toml). Tasks to test for:
  - Building
  - Linting
  - Formatting
  - Testing
...
- Setup Github workflow that runs all checks when pull requests are open: [https://github.com/kawa-protocol/rover/blob/master/.github/workflows](https://github.com/kawa-protocol/rover/blob/master/.github/workflows).
