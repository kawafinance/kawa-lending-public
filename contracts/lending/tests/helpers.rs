...
use kawa_testing::{mock_dependencies, mock_env, mock_info, KawaMockQuerier, MockEnvParams};
...
pub fn th_setup(contract_balances: &[Coin]) -> OwnedDeps<MockStorage, MockApi, KawaMockQuerier> {
