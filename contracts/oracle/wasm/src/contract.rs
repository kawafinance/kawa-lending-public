...
use kawa_oracle_base::OracleBase;
use kawa_lending_types::oracle::{WasmOracleCustomExecuteMsg, WasmOracleCustomInitParams};
...
pub mod entry {
    ...
    use kawa_oracle_base::{ContractError, ContractResult};
    use kawa_lending_types::oracle::msg::{ExecuteMsg, InstantiateMsg, QueryMsg};
