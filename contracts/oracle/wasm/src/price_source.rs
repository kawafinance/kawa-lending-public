...
use kawa_oracle_base::{
    pyth::PriceIdentifier,
    ContractError::{self},
    ContractResult, PriceSourceChecked, PriceSourceUnchecked,
};
use kawa_lending_types::oracle::{AstroportTwapSnapshot, Config};
    ...
    fn validate(
        ...
        match self {
            ...
            WasmPriceSource::Pyth {
                ...
                kawa_oracle_base::pyth::assert_usd_price_source(deps, price_sources)?;
    ...
    fn query_price(
        ...
        match self {
            ...
            WasmPriceSource::Pyth {
                ...
                max_staleness,
                denom_decimals,
            } => kawa_oracle_base::pyth::query_pyth_price(
                deps,
                env,
                contract_addr.clone(),
                *price_feed_id,
