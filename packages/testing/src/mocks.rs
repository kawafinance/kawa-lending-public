...
use super::kawa_mock_querier::KawaMockQuerier;
...
pub fn mock_dependencies(
    ...
    let custom_querier: KawaMockQuerier =
        KawaMockQuerier::new(MockQuerier::new(&[(contract_addr.as_ref(), contract_balance)]));
