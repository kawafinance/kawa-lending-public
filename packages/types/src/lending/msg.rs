...
use crate::lending::InterestRateModel;
...
pub enum QueryMsg {
    /// Get config
    #[returns(crate::lending::ConfigResponse)]
    Config {},

    /// Get asset market
    #[returns(crate::lending::Market)]
    Market {
        denom: String,
    },

    /// Enumerate markets with pagination
    #[returns(Vec<crate::lending::Market>)]
    Markets {
    ...
    #[returns(crate::lending::UncollateralizedLoanLimitResponse)]
    ...
    #[returns(Vec<crate::lending::UncollateralizedLoanLimitResponse>)]
    ...
    #[returns(crate::lending::UserDebtResponse)]
    UserDebt {
        user: String,
        denom: String,
    },
    ...
    #[returns(Vec<crate::lending::UserDebtResponse>)]
    UserDebts {
        user: String,
        start_after: Option<String>,
        limit: Option<u32>,
    ...
    #[returns(crate::lending::UserCollateralResponse)]
    UserCollateral {
        user: String,
        denom: String,
    },
    ...
    #[returns(Vec<crate::lending::UserCollateralResponse>)]
    UserCollaterals {
        user: String,
        start_after: Option<String>,
        limit: Option<u32>,
    ...
    /// Get user position
    #[returns(crate::lending::UserPositionResponse)]
    UserPosition {
        user: String,
    },
