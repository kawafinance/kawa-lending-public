...
export interface KawaOracleWasmReadOnlyInterface {
...
export class KawaOracleWasmQueryClient implements KawaOracleWasmReadOnlyInterface {
...
export interface KawaOracleWasmInterface extends KawaOracleWasmReadOnlyInterface {
  contractAddress: string
  sender: string
  setPriceSource: (
    {
...
export class KawaOracleWasmClient
  extends KawaOracleWasmQueryClient
  implements KawaOracleWasmInterface
{
